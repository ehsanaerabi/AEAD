...
//encrypt 32 bit
void encrypt_32bits(unsigned long long *state, unsigned int plaintextword, unsigned int *ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f,ks;
...
void encrypt_32bits_fast(unsigned long long *state, unsigned int plaintextword, unsigned int *ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f, ks;
    unsigned long long word_244, word_23, word_160, word_111, word_66, word_196, word_0, word_107, word_230;
    unsigned long long word_12,word_154,word_235,word_61,word_193;
...
void encrypt_8bits(unsigned long long *state, unsigned int plaintextword, unsigned int *ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f,ks;
    unsigned long long word_244, word_23, word_160, word_111, word_66, word_196, word_0, word_107, word_230;
    unsigned long long word_12,word_154,word_235,word_61,word_193;
...
void decrypt_32bits(unsigned long long *state, unsigned int *plaintextword, unsigned int ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f,ks;
    unsigned long long word_244, word_23, word_160, word_111, word_66, word_196, word_0, word_107, word_230;
    unsigned long long word_12,word_154,word_235,word_61,word_193;
...
//decrypt 32 bit.  This function is used when cb = 0
void decrypt_32bits_fast(unsigned long long *state, unsigned int *plaintextword, unsigned int ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f, ks;
    unsigned long long word_244, word_23, word_160, word_111, word_66, word_196, word_0, word_107, word_230;
    unsigned long long word_12,word_154,word_235,word_61,word_193;
...
void decrypt_8bits(unsigned long long *state, unsigned int *plaintextword, unsigned int ciphertextword, unsigned int ca, unsigned int cb)
{
    unsigned int f, ks;
    unsigned long long word_244, word_23, word_160, word_111, word_66, word_196, word_0, word_107, word_230;
    unsigned long long word_12,word_154,word_235,word_61,word_193;
...
void acorn128_initialization_32bitversion(const unsigned char *key, const unsigned char *iv, unsigned long long *state)
{
        ...
        for (j = 0;  j <= 3;  j++)
        {
            encrypt_32bits(state, ((unsigned int*)key)[j], &tem, 0xffffffff, 0xffffffff);
        }
        for (j = 4;  j <= 7;  j++)
        {
            encrypt_32bits(state, ((unsigned int*)iv)[j-4], &tem, 0xffffffff, 0xffffffff);
        }
        for (j = 8;  j <= 8; j++)
        {
            encrypt_32bits(state, ((unsigned int*)key)[j&3] ^ 1, &tem, 0xffffffff, 0xffffffff);
        }
        for (j = 9;  j <= 55; j++)
        {
            encrypt_32bits(state, ((unsigned int*)key)[j&3], &tem, 0xffffffff, 0xffffffff);
        }
...
void acorn128_tag_generation_32bits_version(unsigned long long msglen, unsigned long long adlen, unsigned char maclen, unsigned char *mac, unsigned long long *state)
{
    ...
    for (i = 0; i < 768/32; i++)
    {
        ...
        if ( i >= (768/32 - 4) ) { ((unsigned int*)mac)[i-(768/32-4)] = ciphertextword; }
    }
}

// 256-bit padding after the associated data and the plaintext/ciphertext
void acorn128_padding_256(unsigned long long *state, unsigned int cb)
{
	...
	)
{
    ...
    {
        encrypt_32bits(state, ((unsigned int*)ad)[i], &ciphertextword, ca, cb);
    }
    ...
    {
        encrypt_32bits_fast(state, ((unsigned int*)m)[i], &(((unsigned int*)c)[i]), ca, cb);  //&c[i], &ksword, ca, cb);
    }
	...
	)
{
    ...
    *mlen = clen - 16;
    ...
    for (i = 0; i < *mlen/4; i=i+1)
    {
        decrypt_32bits_fast(state, &(((unsigned int*)m)[i]), ((unsigned int*)c)[i], ca, cb);  //&c[i], &ksword, ca, cb);
    }
